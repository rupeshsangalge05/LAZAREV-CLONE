...
function page2Animation() {
    ...
    var rightElemsImg = document.querySelectorAll(".right-elem img")
...
// function page5SummaryArrow(){
//     var summaryHeading = document.querySelectorAll("summary .arrow")
//     summaryHeading.forEach(function(elem){
//         // elem.addEventListener("click",function(){
//         //     // elem.childNodes[2].style.rotate = "180deg,"
